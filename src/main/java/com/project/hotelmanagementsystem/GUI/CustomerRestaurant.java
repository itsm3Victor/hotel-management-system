...
//            ResultSet rs= st.executeQuery(query);
            ...
            int currentIndex = 0;
            while(currentIndex < roomList.size()){
                model.addRow(new Object[] {
                        roomList.get(currentIndex).getRoomno(),
                        roomList.get(currentIndex).getRoomType(),
                        roomList.get(currentIndex).getBedtype(),
                        roomList.get(currentIndex).getPrice()
                });
                currentIndex ++;
            }
//            while(rs.next())
...
//        ResultSet result = null;
        try {
            customerRestaurantService.addToDatabase(name.getText(), addr.getText(), phone.getText(), roomtype.getText(), bedtype.getText(), tot.getText(), "0");
//            GetConnection connect=new GetConnection();
//            Connection conn=connect.getConnection();
...
//        ResultSet result = null;
        try {
            customerRestaurantService.checkOut(name.getText());
//            GetConnection connect=new GetConnection();
//            Connection conn=connect.getConnection();
